...
func _ready():
	...
	ItemSlot3_tex.texture = load("res://assets/consumables/smallHpBottle1.png")
	
	ItemSlot4_label.text = 4 as String
	ItemSlot4_tex.texture = load("res://assets/consumables/HpBottle1.png")
...
func _process(_delta):
	...
	ItemSlot3_amount.text = Data.small_hp_bottle_amount as String
	ItemSlot4_amount.text = Data.hp_bottle_amount as String
